...
class MplCanvas(FigureCanvas):
    ...
    def __init__(self):
        ...
        #plt.axis('tight')
        ax1 = self.fig.add_subplot(gs[ :2, 0:4])  # ΣC + ΣP
        ax2 = self.fig.add_subplot(gs[ :1, 4:6], sharex=ax1) # P1 or C1
        ax6 = self.fig.add_subplot(gs[1:2, 4:6], sharex=ax1) # P2 or C2
        ax3 = self.fig.add_subplot(gs[ :1, 6:8], sharex=ax1, sharey=ax2) # P3 or C3
